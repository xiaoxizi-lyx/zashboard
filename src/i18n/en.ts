const en = {
  ...
  geoCity: 'City',
  geoOrg: 'Organization',
  extraGeoInfo: 'Extended geo info',
  ...
  privacyKnownBot: 'Known bot',
  threatIntel: 'Threat intelligence',
  threatIsThreat: 'Is threat',
  threatFirstSeen: 'First seen',
  threatLastSeen: 'Last seen',
  threatRecentAbuse: 'Recent abuse',
  threatHistoryAbuse: 'History abuse',
  proxyIntel: 'Proxy intelligence',
  proxyIsProxy: 'Is proxy',
  proxySources: 'Sources',
  proxyActiveDays7d: 'Active days (7d)',
  proxyActiveDays30d: 'Active days (30d)',
  proxyActiveDays90d: 'Active days (90d)',
  proxyTotalDaysSeen: 'Total days seen',
  proxyFirstSeen: 'First seen',
  proxyLastSeen: 'Last seen',
  dl: 'DL',
  ul: 'UL',
  dlSpeed: 'DL speed',
  ulSpeed: 'UL speed',
  ...
  customIPAPIKey: 'Custom IP API key',
  customIPAPIKeyTip: 'Enter the key for a custom IP info API. In connection details, this API will query in parallel with the other three APIs for multi-source comparison. Leave empty to disable.',
  customIPAPIKeyPlaceholder: 'Enter API key',
  general: 'General',
