...
const zh: LANG_MESSAGE = {
  ...
  privacyAnonymous: '匿名',
  privacyKnownBot: '已知爬虫',
  threatIntel: '威胁情报',
  threatIsThreat: '存在威胁',
  threatFirstSeen: '首次发现',
  threatLastSeen: '最后发现',
  threatRecentAbuse: '近期滥用',
  threatHistoryAbuse: '历史滥用',
  proxyIntel: '代理情报',
  proxyIsProxy: '是代理',
  proxySources: '来源数',
  proxyActiveDays7d: '活跃天数(7天)',
  proxyActiveDays30d: '活跃天数(30天)',
  proxyActiveDays90d: '活跃天数(90天)',
  proxyTotalDaysSeen: '累计发现天数',
  proxyFirstSeen: '首次发现',
  proxyLastSeen: '最后发现',
  dl: '下载',
  ul: '上传',
  ...
  customIPAPIKey: '自定义IP API密钥',
  customIPAPIKeyTip: '填写自定义IP信息API的密钥。连接详情中将使用此API与其他三个API并行查询进行多源对比。留空则不启用自定义API。',
  customIPAPIKeyPlaceholder: '输入API密钥',
  general: '通用',
